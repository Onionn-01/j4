...
public interface ArticleRepository extends JpaRepository<Article, Integer> {
    ...
    @Query("SELECT new com.newsapp.dto.ArticleWithEditorDTO(a.articleID, a.title, a.content, a.editorID, u.name, a.status, a.publishDate, a.createdAt, a.updatedAt, a.isDeleted) " +
